...
static int razer_get_report(struct usb_device *usb_dev, struct razer_report *request, struct razer_report *response)
{
    ...
    case USB_DEVICE_ID_RAZER_BASILISK_V3_PRO_35K_VIA_HYPERFLUX_V2:
...
static const struct hid_device_id razer_devices[] = {
    ...
    { HID_USB_DEVICE(USB_VENDOR_ID_RAZER,USB_DEVICE_ID_RAZER_BASILISK_V3_PRO_35K_VIA_HYPERFLUX_V2) },
